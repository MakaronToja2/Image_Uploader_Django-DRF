...
Currently the project supports three build-in groups that have abilities to create 200x200 thumbnails (Basic), 400x400 and same as Basic (Enterprise), and link to original image, expiring image (specified after 300-30000 sec),
